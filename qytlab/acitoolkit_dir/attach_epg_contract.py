...
def attach_epg_contract(tenant_name, ap_name, epg_name, provided_contract="", consumed_contract=""):
...
if __name__ == "__main__":
    attach_epg_contract(config_data.get("tenant"),
                        config_data.get("ap"),
